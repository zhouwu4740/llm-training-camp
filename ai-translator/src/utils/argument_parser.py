...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_provider', type=str, default='openai', help='Model provider.',
        ...
        self.parser.add_argument("--pages", type=int, default=None, help="Number of pages to translate.")
